...
`ws/protocol.py`. Chat messages are broadcast through Redis (see `manager.py`)
so the realtime loop is proven end-to-end; persistence is the next feature.
"""
...
from auth.deps import get_current_user_ws
from ws.constants import AUTH_ERROR_WS_CODE
from ws.manager import Connection, manager
from ws.protocol import IncomingMessage, outgoing
